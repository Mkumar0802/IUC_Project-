    ...
    <>
      ...
      <div className='bg-sky-50'>
        <div className='px-40'>
          ...
          <div className='w-1/4 font-radio text-black  '>
            IUC Computers –A reliable gateway for success!!!
            "It is never too late to be what you might have been"
            <ul className='text-right text-xl'>-George Eliot</ul>
          </div>
        </div>
        <div>
          ...
          <div className='grid grid-cols-3  px-36 gap-16 mt-10 mb-10 py-9'>
            <div data-aos="fade-right" className='bg-white hover:bg-indigo-200  px-10 py-10 rounded-xl hover:shadow-xl transition ease-in-out delay-75  hover:-translate-y-1 hover:scale-110 duration-100 shadow-xl '>
              <div className='text-center'>
                <h1 className='text-2xl font-popins underline p-2'>Graduate and professional Zone</h1>
              </div>
              <div>
                <ul className=''>
                  <li className='text-xl font-medium  font-popins underline flex'><span className='py-1 animate-bounce'><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div data-aos="flip-left"   className='bg-white hover:bg-indigo-200  px-10 py-10 rounded-xl hover:shadow-xl transition ease-in-out delay-75  hover:-translate-y-1 hover:scale-110 duration-100  shadow-xl '>
              <div className='text-center'>
                <h1 className='text-2xl font-popins underline p-2 py-6'>School Zone</h1>
              </div>
              <div>
                <ul className=''>
                  <li className='text-xl font-medium  font-popins underline flex'><span className='py-1  animate-bounce '><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <li className='text-xl font-medium font-popins underline flex'><span className='py-1    animate-bounce animate-infinite '><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M10.293 15.707a1 1 0 010-1.414L14.586 10l-4.293-4.293a1 1 0 111.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                    <path fill-rule="evenodd" d="M4.293 15.707a1 1 0 010-1.414L8.586 10 4.293 5.707a1 1 0 011.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z" clip-rule="evenodd" />
            ...
            <div data-aos="fade-left"  className=' bg-white hover:bg-indigo-300  px-10 py-10 rounded-xl hover:shadow-xl transition ease-in-out delay-75  hover:-translate-y-1 hover:scale-110 duration-100  shadow-xl '>
              <div className='text-center'>
