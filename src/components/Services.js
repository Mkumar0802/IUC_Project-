    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-3 px-40 cursor-default'>
                <div data-aos="fade-right"   class="max-w-sm rounded overflow-hidden shadow-lg hover:shadow-2xl  shadow-indigo-100  hover:shadow-indigo-100  ">
                ...
                <div data-aos="fade-up" class="max-w-sm rounded overflow-hidden shadow-lg hover:shadow-2xl  shadow-indigo-100  hover:shadow-indigo-100 ">
                ...
                <div  data-aos="fade-left" class="max-w-sm rounded overflow-hidden shadow-lg hover:shadow-2xl  shadow-indigo-100  hover:shadow-indigo-100 ">
