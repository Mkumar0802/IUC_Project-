...
function Services() {
    return (
        <div>
            ...
            <div className='md:grid grid-cols-3 sm:grid grid-rows-3  md:px-36  md:mt-10 md:mb-10 md:py-9  md:gap-16 px-5 space-y-10'>
                <div data-aos="fade-right" className='bg-white md:hover:bg-indigo-200  px-10 py-10 rounded-xl hover:shadow-xl transition ease-in-out delay-75  md:hover:-translate-y-1 md:hover:scale-110 duration-100  shadow-xl '>
                    <div className='text-center'>
                        <h1 className='md:text-2xl font-popins underline p-2 py-6'>Graduate and professional Zone</h1>
                    </div>
                    <div>
                        <ul className=''>
                            <li className='md:text-xl font-medium  font-popins underline flex'><span className='py-1 md:animate-bounce'><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div data-aos="flip-left" className='bg-white md:hover:bg-indigo-200  px-10 py-10 rounded-xl hover:shadow-xl transition ease-in-out delay-75  md:hover:-translate-y-1 md:hover:scale-110 duration-100  shadow-xl '>
                    <div className='text-center'>
                    ...
                    <div>
                        <ul className=''>
                            ...
                            <li className='md:text-xl font-medium font-popins underline flex'><span className='py-1    md:animate-bounce animate-infinite '><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M10.293 15.707a1 1 0 010-1.414L14.586 10l-4.293-4.293a1 1 0 111.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                                <path fill-rule="evenodd" d="M4.293 15.707a1 1 0 010-1.414L8.586 10 4.293 5.707a1 1 0 011.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                ...
                <div data-aos="fade-left" className=' bg-white md:hover:bg-indigo-300  px-10 py-10 rounded-xl hover:shadow-xl transition ease-in-out delay-75  md:hover:-translate-y-1 md:hover:scale-110 duration-100  shadow-xl '>
                    <div className='text-center'>
