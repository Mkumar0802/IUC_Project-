    ...
    return (
        <div className='flex  font-popins '>
            <div data-aos="fade-up">
                <div className='w-full h-4/6 lg:h-5/6 flex flex-col-reverse lg:flex-row space-x-28 px-32'>


                    <div  className='w-2/6 mt-32 flex  '>
                        <ul>
                            <li className='font-popins text-3xl'> IUC Computers CIT Nagar</li>
                            <li className='w-4/6  text-slate-500'>  We would be happy to hear from you, please fill in the form below or mail us your requirements on</li>
