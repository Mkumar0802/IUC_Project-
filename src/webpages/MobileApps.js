          ...
          <div className='flex justify-center p-44'>
            <div className=''>
              ...
              <ul className='flex'>
                ...
                <li className='flex py-5 px-3 cursor-not-allowed'><button className=' rounded-full p-3  px-1 py-1 hover:bg-blue-700   flex  text-justify hover:ring-4  cursor-not-allowed  '>Mobile Apps</button></li>
