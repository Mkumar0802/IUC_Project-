		...
		bg-[url('https://cdn.pixabay.com/photo/2015/08/24/12/53/banner-904884_960_720.jpg')]  h-96 w-full bg-cover bg-center">
            ...
            <div className='bg-gradient-to-r from-indigo-900 to-blue-500 flex justify-center text-white'>
                <ul className='flex'>
                    ...
                    <li className='flex py-5 px-3 cursor-not-allowed'><button className=' rounded-full p-3  px-1 py-1 hover:bg-blue-700   flex  text-justify hover:ring-4  cursor-not-allowed  '>C C++ Training</button></li>
            ...
            <div>
                <h1 className='text-2xl font-popins p-5  opacity-75 px-28'>
                    <span className='text-indigo-900  text-3xl font-extrabold '>C C++ </span>Training
                </h1>
                <div>
                    <ul className='space-y-3 px-28 mt-4'>
                        <li className='text-slate-500 font-radio'>IUC provides you clear view of the computer languages and makes expert in c, c++ languages training in Chennai. Also we are fully concentrating on theory, practical and interview point of view so we can give you nice feature.

                            Java was originally developed by James Gosling at Sun Microsystems and released in 1995 as a core component of Sun Microsystems Java platform. Java is fast, secure, and reliable. The Java programming language is a high-level language.java is class based object-oriented programming language.</li>
                        ...
                        <li className='mt-10 text-xl font-semibold font-popins  text-black'>HISTROY OF C C++</li>
                        <li className='text-slate-500 font-radio'>C programming language features were derived from an earlier language called “B” (Basic Combined Programming Language – BCPL) ).C Programming Language developed for the UNIX operating system by Dennis Ritchie in 1972 at AT&T Bell Labs in USA. The C programming language is a popular and widely used programming language for creating computer programs. IUC professionals have good knowledge in earlier languages of c, c++ so we can give you nice training in Chennai. That’s why we can make you the very best.</li>
                        <li className='mt-10 text-2xl font-semibold font-popins  text-black'>Benefits of C C++</li>
                        <li className='text-slate-500 font-radio'></li>
                        <li className='text-slate-500 font-radio'></li>
                        <li className='mt-10 text-xl font-semibold font-popins  text-black'>Portability</li>
                        <li className='text-slate-500 font-radio'>we can compile or execute C program in any operating system(unix,dos,windows). Powerful programming language: C is very efficient and powerful programming language, it is best used for data structures and designing system software.</li>
                        <li className='text-slate-500 font-radio'>Some of the features of C Programming are modular programming language,portable and recursive. If you are a programmer, or if you are interested in becoming a programmer, there are a couple of benefits you gain from learning C.</li>
                        <li className='text-slate-500 font-radio'>You will be able to read and write code for a large number of platforms — everything from microcontrollers to the most advanced scientific systems can be written in C, and many modern operating systems are written in C.</li>
                        <li className='text-slate-500 font-radio'>The C++ programming language has a history since 1979, when Bjarne Stroustrup was doing work for his Ph.D. thesis. His goal was to add object-oriented programming into the C language, which was and still is a language well-respected for its portability without sacrificing speed or low-level functionality. His language included classes, basic inheritance, in lining, default function arguments, and strong type checking in addition to all the features of the C language. In 1983, the name of the language was changed from C with Classes to C++.</li>
                        <li className='text-slate-500 font-radio'>C ++ is an Objected Oriented Programming Language which has features like<span className='font-semibold font-popins '>Class, Object, Data Encapsulation, Data Abstraction, Inheritance, Polymorphism and Message Passing.</span>  C++ is a Bottom Up Approach and program is divided into objects. C++ is the basic for Object Oriented Programming Language.</li>
                        <li className='text-slate-500 font-radio'>The following topics are covered by our professionals in our IUC Computers C C++ Training in Chennai</li>
                    </ul>
                    ...
                    <div className='flex justify-start'>
                        <div className='px-28'>
                            <ul className='space-y-5 mb-5 mt-5  font-radio text-slate-500'>
                                <li className='mt-10 text-xl font-semibold font-popins  text-black'>C Training Syllabus</li>
                                <li className='mt-10 text-xl font-semibold font-popins  text-black'>Introduction C</li>

                                <li className='hover:text-black hover:underline  flex gap-1' ><div className='text-indigo-900 text-base'><ion-icon name="caret-forward-outline"></ion-icon> </div>The C Language and its Advantages</li>
                                <li className='hover:text-black hover:underline  flex gap-1' ><div className='text-indigo-900 text-base'><ion-icon name="caret-forward-outline"></ion-icon> </div>The Structure of a C Program </li>
                                <li className='hover:text-black hover:underline  flex gap-1' ><div className='text-indigo-900 text-base'><ion-icon name="caret-forward-outline"></ion-icon> </div>Writing C Programs</li>
                        ...
                        <div className='px-28'>
                            <ul className='space-y-5 mb-5 mt-5  font-radio text-slate-500'>
                                ...
                                <li className='hover:text-black hover:underline  flex gap-1' ><div className='text-indigo-900 text-base'><ion-icon name="caret-forward-outline"></ion-icon> </div>Arrays of pointerss</li>
                                <li className='hover:text-black hover:underline  flex gap-1' ><div className='text-indigo-900 text-base'><ion-icon name="caret-forward-outline"></ion-icon> </div>Memory slicing</li>
                                ...
                                <li className='hover:text-black hover:underline  flex gap-1' ><div className='text-indigo-900 text-base'><ion-icon name="caret-forward-outline"></ion-icon> </div>Friends to a class</li>
